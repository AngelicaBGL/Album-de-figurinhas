...
typedef struct{
  char figurinhas_coladas;
  char figurinhas_nao_coladas;
  char figurinhas_faltantes;
  char figurinhas_repetidas;
...
void mostra(Figurinha* figurinha, Album album, int numero, int total, char secao[]){
   ...
   for(int i=0; i<total; i++){
      ...
      if(strcasecmp(figurinha[i].secao, secao)==0){
         ...
         if(strcasecmp(album.figurinhas_coladas[j],figurinha[i].codigo)==0){
            quantidade++;
         }//if2
         }//for2
         if(quantidade<=0){
...
void simbolos(Figurinha* figurinha, Album selecionado,int quant_fig){
   ...
   mostra(figurinha, selecionado, 8, quant_fig, 'Content');                                                       
}
void estadios_e_bola(Figurinha* figurinha, Album selecionado,int quant_fig){
   ...
   mostra(figurinha, selecionado, 10, quant_fig, 'Stadiums');
   mostra(figurinha, selecionado, 1, quant_fig, 'Official Match Ball');
}
void qatar(Figurinha* figurinha, Album selecionado,int quant_fig){
   ...
   mostra(figurinha, selecionado, 20, quant_fig, 'Qatar');
}
void equador(Figurinha* figurinha, Album selecionado,int quant_fig){
   ...
   mostra(figurinha, selecionado, 20, quant_fig, 'Ecuador');
}
void senegal(Figurinha* figurinha, Album selecionado,int quant_fig){
   ...
   mostra(figurinha, selecionado, 20, quant_fig, 'Senegal');
}
void holanda(Figurinha* figurinha, Album selecionado,int quant_fig){
   ...
   mostra(figurinha, selecionado, 20, quant_fig, 'Netherlands');
}
void inglaterra(Figurinha* figurinha, Album selecionado,int quant_fig){
   ...
   mostra(figurinha, selecionado, 20, quant_fig, 'England');
}
void ira(Figurinha* figurinha, Album selecionado,int quant_fig){
   ...
   mostra(figurinha, selecionado, 20, quant_fig, 'Iran');
}
void estados_unidos(Figurinha* figurinha, Album selecionado,int quant_fig){
   ...
   mostra(figurinha, selecionado, 20, quant_fig, 'USA');
}
void pais_de_gales(Figurinha* figurinha, Album selecionado,int quant_fig){
   ...
   mostra(figurinha, selecionado, 20, quant_fig, 'Wales');
}
void argentina(Figurinha* figurinha, Album selecionado,int quant_fig){
   ...
   mostra(figurinha, selecionado, 20, quant_fig, 'Argentina');
}
void arabia_saudita(Figurinha* figurinha, Album selecionado,int quant_fig){
   ...
   mostra(figurinha, selecionado, 20, quant_fig, 'Saudi Arabia');
}
void mexico(Figurinha* figurinha, Album selecionado,int quant_fig){
   ...
   mostra(figurinha, selecionado, 20, quant_fig, 'Mexico');
}
void polonia(Figurinha* figurinha, Album selecionado,int quant_fig){
   ...
   mostra(figurinha, selecionado, 20, quant_fig, 'Poland');
}
void franca(Figurinha* figurinha, Album selecionado,int quant_fig){
   ...
   mostra(figurinha, selecionado, 20, quant_fig, 'France');
}
void australia(Figurinha* figurinha, Album selecionado,int quant_fig){
   ...
   mostra(figurinha, selecionado, 20, quant_fig, 'Australia');
}
void dinamarca(Figurinha* figurinha, Album selecionado,int quant_fig){
   ...
   mostra(figurinha, selecionado, 20, quant_fig, 'Denmark');
}
void tunisia(Figurinha* figurinha, Album selecionado,int quant_fig){
   ...
   mostra(figurinha, selecionado, 20, quant_fig, 'Tunisia');
}
void espanha(Figurinha* figurinha, Album selecionado,int quant_fig){
  ...
  mostra(figurinha, selecionado, 20, quant_fig, 'Spain');
}
void costa_rica(Figurinha* figurinha, Album selecionado,int quant_fig){
   ...
   mostra(figurinha, selecionado, 20, quant_fig, 'Costa Rica');
}
void alemanha(Figurinha* figurinha, Album selecionado,int quant_fig){
   ...
   mostra(figurinha, selecionado, 20, quant_fig, 'Germany');
}
void japao(Figurinha* figurinha, Album selecionado,int quant_fig){
   ...
   mostra(figurinha, selecionado, 20, quant_fig, 'Japao');
}
void belgica(Figurinha* figurinha, Album selecionado,int quant_fig){
   ...
   mostra(figurinha, selecionado, 20, quant_fig, 'Belgium');
}
void canada(Figurinha* figurinha, Album selecionado,int quant_fig){
   ...
   mostra(figurinha, selecionado, 20, quant_fig, 'Canada');
}
void marrocos(Figurinha* figurinha, Album selecionado,int quant_fig){
   ...
   mostra(figurinha, selecionado, 20, quant_fig, 'Marrocco');
}
void croacia(Figurinha* figurinha, Album selecionado,int quant_fig){
   ...
   mostra(figurinha, selecionado, 20, quant_fig, 'Croatia');
}
void brasil(Figurinha* figurinha, Album selecionado,int quant_fig){
   ...
   mostra(figurinha, selecionado, 20, quant_fig, 'Brazil');
}
void servia(Figurinha* figurinha, Album selecionado,int quant_fig){
   ...
   mostra(figurinha, selecionado, 20, quant_fig, 'Serbia');
}
void suica(Figurinha* figurinha, Album selecionado,int quant_fig){
   ...
   mostra(figurinha, selecionado, 20, quant_fig, 'Switzerland');
}
void camaroes(Figurinha* figurinha, Album selecionado,int quant_fig){
   ...
   mostra(figurinha, selecionado, 20, quant_fig, 'Cameroon');
}
void portugal(Figurinha* figurinha, Album selecionado,int quant_fig){
   ...
   mostra(figurinha, selecionado, 20, quant_fig, 'Portugal');
}
void gana(Figurinha* figurinha, Album selecionado,int quant_fig){
   ...
   mostra(figurinha, selecionado, 20, quant_fig, 'Ghana');
}
void uruguai(Figurinha* figurinha, Album selecionado,int quant_fig){
   ...
   mostra(figurinha, selecionado, 20, quant_fig, 'Uruguay');
}
void coreia_do_sul(Figurinha* figurinha, Album selecionado,int quant_fig){
   ...
   mostra(figurinha, selecionado, 20, quant_fig, 'Korea Republic');
}
void museu_da_fifa(Figurinha* figurinha, Album selecionado,int quant_fig){
   ...
   mostra(figurinha, selecionado, 11, quant_fig, 'FIFA Museum');
}
void coca_cola(Figurinha* figurinha, Album selecionado,int quant_fig){
   ...
   mostra(figurinha, selecionado, 20, quant_fig, 'CocanormalCola Team Believers');
}
...
void comprar_envelope(Figurinha* figurinha,Album* selecionado){
  srand(time(NULL));
    ...
    for (int i = 0; i < 5; i++)
    {
        ...
        if (selecionado->posicao_no_album == 0)
        {
...
void trocar_figurinha(char repetida, Figurinha* figurinha, Album* selecionado){
   int probabilidade;
   int sorteio;
   srand(time(0));
      ...
      for(int i=0; i<10; i++){
         for(int j=0; j<10; j++){
            if(strcasecmp(figurinha[i].codigo, repetida)==1){
               ...
               selecionado->quant_colada++;
               strcpy(selecionado->figurinhas_coladas[selecionado->quant_colada],figurinha[i].codigo);
            }
         }
      }
   }
  ...
  while (menu!=0){
   ...
   switch (menu){
      ...
      case 1:
        ...
        folhear_album(figurinha,selecionado,quant_fig);
        break;
      case 2:
         do{
         ...
         if(moedas>4){
            ...
            scanf("%s", seletor);
            selecionado = album[seletor];
            selecionado.dinheiro_gasto = selecionado.dinheiro_gasto + 4; 
            comprar_envelope();
            album[seletor] = selecionado;
         }else{
      ...
      case 9:
         ...
         __fpurge(stdin);
         for(int i=0;i<quant_fig; i++){
            if(strcasecmp(repetida,album[seletor].figurinhas_repetidas[i])==0){
               strcpy(album[seletor].figurinhas_repetidas[i],"0000000000");
            }
         }
         trocar_figurinha(repetida, figurinha, &selecionado); 
         album[seletor]=selecionado;        
         break;
      default:
